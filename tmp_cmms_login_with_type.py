...
# Try with 'type': 'user'
creds_user = {"email": "mike@cranesync.com", "password": "CraneSync2026!", "type": "user"}
creds_admin = {"email": "mike@cranesync.com", "password": "CraneSync2026!", "type": "admin"}

for cred in [creds_user, creds_admin]:
